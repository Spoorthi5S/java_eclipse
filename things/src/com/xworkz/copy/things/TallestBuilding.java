...
public class TallestBuilding {
    ...
    public TallestBuilding(String name,String type,String Architectur,int  noOfBuildings,boolean isTheySafe,String[] typesOfBuildings,String[] typesOfdesigns,String[] typesOfBuilders,double[] area,long[] priceOfTheBuilding,String[] countryNames)
    {
   	 this.name = name;
   	 this.type = type;
