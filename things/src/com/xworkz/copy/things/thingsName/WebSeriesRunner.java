...
import com.xworkz.copy.things.WebSeries;
...
public class WebSeriesRunner {
	...
	public static void main(String[] args) {
		...
		WebSeries webseries= new WebSeries("House Of The Dragon",'A',"Matt Smith",25,true,items1,items2,items3,items4,items5,items6);
