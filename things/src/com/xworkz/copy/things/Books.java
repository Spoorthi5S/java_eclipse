...
public class Books {
	...
	public Books(String BookName,String[] BookType,String[] authors,String[] BookBrand,int quantity,
			float quality,boolean printed,boolean blank, String[] pageType,String[] bindType,String[] pageNum)
	{
